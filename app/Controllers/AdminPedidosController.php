...
class AdminPedidosController extends Controller {
    ...
    public function atualizarCliente(Request $request, $id = null) {
        ...
        try {
            // Singleton já configura MYSQL_ATTR_FOUND_ROWS => true.
...
<body>
    ...
    <div class="container-fluid">
        ...
        echo '<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            $colsPedido = [];
            try {
                $pdoCols = \Config\Database::getConnection();
            ...
            try {
                ...
                if (!($pdoWarn instanceof \PDO)) {
                    $pdoWarn = \Config\Database::getConnection();
                }
            ...
            try {
                ...
                try {
                    if (isset($pdoCols) && ($pdoCols instanceof \PDO)) {
                        ...
                        $pdoTrack = \Config\Database::getConnection();
                    }
                } catch (\Exception $e) {
                    $pdoTrack = null;
                }
            ...
            try {
                ...
                try {
                    if (isset($pdoCols) && ($pdoCols instanceof \PDO)) {
                        ...
                        $pdoLocal2 = \Config\Database::getConnection();
                    }
                } catch (\Exception $e) {
                    $pdoLocal2 = null;
                }
            ...
            try {
                ...
                if (!empty($pids)) {
                    ...
                    if (!($pdoProd instanceof \PDO)) {
                        $pdoProd = \Config\Database::getConnection();
                    }
            ...
            if ($isCarnePedidoAdmin && $exibirEmBrl) {
                try {
                    $pdoMeta = \Config\Database::getConnection();
            ...
            if ($precisaConverterAdmin && $taxaConvPedido <= 1.01) {
                try {
                    $pdoTx = \Config\Database::getConnection();
                                    ...
                                    try {
                                        ...
                                        if (!empty($rowsSplit)) {
                                            ...
                                            foreach ($rowsSplit as $r) {
                                                ...
                                                $compLabel = $comp;
                                                $compMap = ['PRODUTO' => __('admin.order_details.comp_products', 'Produtos'), 'TAXA_SERVICO' => __('admin.order_details.comp_service_fee', 'Taxa de Serviço'), 'IMPOSTO' => __('admin.order_details.comp_taxes', 'Impostos'), 'IMPOSTO_LOCAL' => __('admin.order_details.comp_local_tax', 'Imposto Local'), 'PAGAMENTO' => __('admin.order_details.comp_total_payment', 'Pagamento Total'), 'TAXA' => __('admin.order_details.comp_service_fee', 'Taxa de Serviço'), 'CARTEIRA' => __('admin.order_details.comp_wallet', 'Carteira (Wallet)'), 'TAXA_GATEWAY' => __('admin.order_details.comp_gateway_taxes_diff', 'Gateway (Impostos + Diferença)')];
...
LINKSCRIPT;
                                    ...
                                    try {
                                        if (isset($pdoCols) && ($pdoCols instanceof \PDO)) {
                                            ...
                                            $pdoLocal = \Config\Database::getConnection();
                                        }
                                    } catch (\Exception $e) {
                                        $pdoLocal = null;
                                    }
