...
class AdminEtiquetasWpController extends Controller
{
    ...
    public function aplicarLayoutEmails(Request $request)
    {
        ...
        // Template HTML padronizado (cabeçalho escuro, corpo branco, box de rastreio, botão, rodapé).
        // Corpo com as orientações sobre impostos e portal dos Correios (texto oficial da Braziliana).
        $montarHtml = function (string $urlBtn): string {
