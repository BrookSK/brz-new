...
<body>
    ...
    public function editar(Request $request) {
        ...
        echo '<!DOCTYPE html>
<html><head><title>Editar Usuário</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head><body>
...
<div class="mb-3"><label>Nome</label><input type="text" class="form-control" name="nome" value="' . htmlspecialchars($usuario['nome']) . '" required></div>
<div class="mb-3"><label>Email</label><input type="email" class="form-control" name="email" value="' . htmlspecialchars($usuario['email']) . '" required></div>
<div class="mb-3"><label>CPF</label><input type="text" class="form-control" name="cpf" value="' . htmlspecialchars($usuario['cpf'] ?? '') . '"></div>
<div class="mb-3"><label>Telefone</label><input type="text" class="form-control" name="telefone" value="' . htmlspecialchars($usuario['telefone'] ?? '') . '"></div>
<div class="mb-3"><label>Nova Senha (opcional)</label><input type="password" class="form-control" name="senha"></div>
<div class="mb-3"><label>Status</label><select class="form-select" name="ativo">
<option value="1" ' . ($usuario['ativo'] ? 'selected' : '') . '>Ativo</option>
<option value="0" ' . (!$usuario['ativo'] ? 'selected' : '') . '>Inativo</option>
</select></div>
<button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Salvar</button>
<a href="/admin/usuarios" class="btn btn-secondary"><i class="fas fa-times me-1"></i>Cancelar</a>
    ...
    public function salvar(Request $request) {
        ...
        if ($request->getParam('senha')) {
            $sql .= ", senha = ?";
            $params[] = password_hash($request->getParam('senha'), PASSWORD_DEFAULT);
        }
    ...
    public function novo(Request $request) {
        ...
        echo '<!DOCTYPE html>
<html><head><title>Novo Usuário</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head><body>
<div class="container-fluid"><div class="row">';
        ...
        echo '<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
<h2><i class="fas fa-user-plus me-2"></i>Novo Usuário</h2>
<form method="POST" action="/admin/usuarios/salvar">
<div class="mb-3"><label>Nome</label><input type="text" class="form-control" name="nome" required></div>
<div class="mb-3"><label>Email</label><input type="email" class="form-control" name="email" required></div>
<div class="mb-3"><label>CPF</label><input type="text" class="form-control" name="cpf"></div>
<div class="mb-3"><label>Telefone</label><input type="text" class="form-control" name="telefone"></div>
