                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 border-top pt-3">
                                        ...
                                        <small class="text-muted d-block mb-2">Quando este produto for adicionado ao carrinho, o brinde será incluído automaticamente (preço $0, taxa e impostos normais — impostos BR devolvidos na carteira).</small>
...
HTMLSCRIPT;
    ...
    public function buscaAjax(Request $request) {
        ...
        try {
            ...
            // Resolver URLs de fotos (fallback para produto_fotos)
            $prodIds = array_column($rows, 'id');
            $fotosMap = [];
            if (!empty($prodIds)) {
                try {
