...
class AdminRemessaConferenciaController extends Controller {
    ...
    public function index($request) {
        ...
        try {
            ...
            $sql = "SELECT rjp.pedido_id, rjp.janela_id, rjp.etiqueta_gerada,
                        rjp.wexpress_shipping_id, rjp.wexpress_tracking_number, rjp.courier_tracking_number,
                        rjp.wexpress_status,
                        p.created_at, p.total, p.status AS pedido_status,
...
<div class="row g-2 text-center">
    ...
    <div class="col-3"><div class="fw-bold">' . number_format($comprimento, 2) . ' cm</div><div class="text-muted small">' . __('admin.shipment_check.length', 'Comprimento') . '</div></div>
        ...
        // Informações Úteis - inclui todos os dados de pedido_pagamentos agrupados por gateway
