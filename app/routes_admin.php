...
$router->post('/admin/clube/toggle', 'AdminClubeRecargasController', 'toggle');
...
$router->post('/admin/etiquetas-wp/criar-fatura', 'AdminEtiquetasWpController', 'criarFatura');
$router->post('/admin/etiquetas-wp/criar-embarque', 'AdminEtiquetasWpController', 'criarEmbarque');
$router->get('/admin/etiquetas-wp/listar-pacotes', 'AdminEtiquetasWpController', 'listarPacotes');
...
$router->get('/admin/etiquetas-wp/aplicar-layout-emails', 'AdminEtiquetasWpController', 'aplicarLayoutEmails');
...
$router->post('/admin/despesas/editar-recorrencia/{id}', 'AdminDespesasController', 'editarRecorrencia');
$router->post('/admin/despesas/pagar-recorrencia/{id}', 'AdminDespesasController', 'pagarRecorrencia');
$router->post('/admin/despesas/cancelar-recorrencia/{id}', 'AdminDespesasController', 'cancelarRecorrencia');
