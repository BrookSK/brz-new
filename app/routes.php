...
$router->get('/desapego', 'DesapegoController', 'index');
...
<body>
    <div class="admin-card">
        <div class="text-center">
            ...
            <h1 class="admin-title">Braziliana Admin</h1>
...
$router->get('/api/produtos/buscar-todos', 'ApiController', 'buscarProdutosTodos');
...
$router->post('/admin/remessa-internacional/janela/{janelaId}/pedido/{pedidoId}/resetar-etiqueta', 'AdminRemessaInternacionalController', 'resetarEtiqueta');
...
$router->get('/admin/remessa-conferencia/janela/{id}/exportar-documentos', 'AdminRemessaConferenciaController', 'exportarDocumentos');
$router->get('/admin/remessa-conferencia/exportar-documentos', 'AdminRemessaConferenciaController', 'exportarDocumentosGlobal');
...
$router->post('/admin/remessa-correios/deletar-etiqueta/{id}', 'AdminRemessaCorreiosController', 'deletarEtiqueta');
