...
$router->get('/admin', function() {
    echo '<h1>Área Admin</h1><p><a href="/admin/dashboard">Ir para Dashboard</a> | <a href="/admin/produtos">Gerenciar Produtos</a> | <a href="/admin/novo-produto">Novo Produto</a> | <a href="/admin/pedidos">Pedidos</a></p>';
});
