    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4 user-page-header">
                <div>
                    <h2 class="mb-1"><?= __('user_tickets.title', 'Meus Tickets') ?></h2>
                    <p class="text-muted mb-0"><?= __('user_tickets.subtitle', 'Acompanhe suas conversas de suporte') ?></p>
                </div>
            </div>
                ...
                <div class="card-body">
                    <?php if (empty($tickets)): ?>
                        <div class="text-center py-5">
                            ...
                            <h5 class="mb-2"><?= __('user_tickets.empty_title', 'Nenhum ticket') ?></h5>
                            <p class="text-muted mb-0"><?= __('user_tickets.empty_subtitle', 'Abra um ticket a partir de um pedido em “Meus Pedidos”.') ?></p>
                        </div>
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?= __('user_tickets.table.subject', 'Assunto') ?></th>
                                        <th><?= __('user_tickets.table.status', 'Status') ?></th>
                                        <th><?= __('user_tickets.table.updated', 'Atualizado') ?></th>
