...
function renderAdminScripts() {
    ...
    echo '<script>
window.abrirPrefsModal=function(){if(typeof bootstrap!=="undefined"){new bootstrap.Modal(document.getElementById("prefsChangeModal")).show();}else{document.getElementById("prefsChangeModal").style.display="block";document.getElementById("prefsChangeModal").classList.add("show");}};
