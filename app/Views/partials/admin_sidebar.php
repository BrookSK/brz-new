...
function renderAdminSidebar($activePage = '') {
    ...
    $menuItems = [
        ...
        'shippo' => ['icon' => 'fas fa-globe-americas', 'label' => 'Shippo (Internacional)', 'url' => '/admin/shippo', 'roles' => ['admin','vendedor']],
    ...
    echo '<nav id="adminSidebar" class="col-md-3 col-lg-2 d-md-block sidebar">
        <div class="position-sticky pt-3">
            ...
            $menuGroups = [
                ...
                'Envios & Etiquetas' => ['icon' => 'fas fa-shipping-fast', 'items' => ['remessa-internacional', 'remessa-wp', 'remessa-conferencia', 'remessa-correios', 'correios-mundial', 'etiquetas-wp', 'pacotes-wordpress', 'remessa-shipstation', 'shippo']],
