...
O endereço informado é usado para:
Calcular regras de envio
Determinar a forma de pagamento disponível
...
Quando o pedido é pago em Dólar, o valor exibido no checkout é o valor final do pedido em Dólar.
7.3. Clientes Fora do Brasil
Cartão de crédito ou débito (USD)
Sem opção de parcelamento
Clientes com conta nos Estados Unidos: Zelle ou Venmo
7.4. Clientes Residentes no Brasil
PIX
Cartão de crédito nacional com parcelamento em até 12x

7.5. Pagamento com Carteira/Saldo (quando disponível)
Se a opção de carteira estiver disponível, poderá ser utilizada para pagar pedidos
...
8.2. Meus Pedidos
Você pode acompanhar o status do pedido na área "Meus Pedidos"
...
Nem todo link pode ser processado (por indisponibilidade, variações do site de origem, preço alterado, restrições, etc.)
Links podem falhar, mudar ou ficar indisponíveis
Preços podem variar até o momento da compra
Valores podem variar se o preço do produto no site de origem mudar
Certos produtos podem ter restrições de envio, tamanho/peso, categoria e/ou destino
Caso o processamento falhe, ele irá criar uma pendência em nosso sistema e tão breve quanto possível um agente irá assumir seu atendimento para auxílio pessoal.

IMPORTANTE: Ainda que o cliente conte com o auxílio do atendimento, a responsabilidade final pela escolha do produto, bem como por suas características, especificações, tamanhos, modelos e compatibilidade, é exclusivamente do cliente, não sendo de responsabilidade, sob nenhuma hipótese, gerencial, jurídica, financeira, logística ou tributária da BRAZILIANA, quaisquer consequências decorrentes dessas escolhas.

9.4. Diferenças de Valor
Este é um processo inovador e pode haver alguma inconsistência. Se isso acontecer, nossa equipe pode entrar em contato para:
Valor final MAIOR que o pago:
Será necessário pagar a diferença para concluir o pedido
Você será notificado e poderá escolher pagar ou cancelar
Valor final MENOR que o pago:
A diferença entra como crédito na sua carteira (quando disponível)
Ou será realizado estorno/reembolso conforme a forma de pagamento
...
17.3. Alterações Após o Pagamento
...
Animais
Armas de fogo e produtos controlados pelo Exército Brasileiro
Artigos Perigosos
Cigarros e Similares
Corrosivos
Dinheiro em Circulação e cheques
...
Procedimentos de compra, recebimento e cadastro de pacotes
Armazenamento e prazos operacionais
Transporte, consolidação, embalagem e logística internacional
Declaração alfandegária e responsabilidades do cliente
