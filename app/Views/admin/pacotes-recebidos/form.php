            ...
            <form method="POST" action="/admin/pacotes-recebidos/salvar" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="form-text text-muted"><?= __('admin.received_packages.photo_formats_optional', 'Opcional. JPG, PNG, WebP ou GIF. Max 5MB. Se não enviar, usamos uma imagem padrão.') ?></small>
                    </div>
