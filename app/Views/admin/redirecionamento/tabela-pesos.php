        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-text"><?= __('admin.redirect.comma_separated_collection_hq_alert', 'Separados por vírgula. Recebem aviso quando um redirecionador agenda coleta ou envia para a sede.') ?></div>
                </div>
                <div class="col-md-10">
                    <label class="form-label"><?= __('admin.redirect.hq_receiving_address', 'Endereço de recebimento (sede)') ?></label>
                    ...
                    <div class="form-text"><?= __('admin.redirect.hq_receiving_address_help', 'Endereço exibido ao redirecionador (na página pública e no painel) quando ele opta por enviar o pacote em vez de agendar coleta.') ?></div>
                </div>
