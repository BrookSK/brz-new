        ...
        <div class="card-body">
            ...
            <div class="row text-center g-3">
                ...
                $steps = [
                    ...
                    ['icon'=>'fa-calendar-check','title'=>__('admin.redirect.step6_title','6. Coleta ou envio'),'desc'=>__('admin.redirect.step6_desc','Agende a coleta na aba "Coletas" ou envie o pacote você mesmo para a nossa sede.')],
