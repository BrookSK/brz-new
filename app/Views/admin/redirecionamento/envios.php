                ...
                <table class="table table-sm table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <?php if (!$isRedirecionador): ?><th><?= __('admin.redirect.redirector', 'Redirecionador') ?></th><?php endif; ?>
                    ...
                    <tbody>
                        <?php if (empty($envios)): ?>
                        <tr><td colspan="<?= $isRedirecionador ? 9 : 10 ?>" class="text-center text-muted py-4"><?= __('admin.redirect.no_shipments_found', 'Nenhum envio encontrado.') ?></td></tr>
