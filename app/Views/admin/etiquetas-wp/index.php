...
<?php endforeach;endif;?>
        ...
        <div class="card ewp-card">
            ...
            <div class="card-body p-0"><div class="table-responsive"><table class="table table-sm table-hover mb-0 align-middle">
                <thead class="table-light"><tr><th>Pedido</th><th>Cliente</th><th>Tracking</th><th class="d-none d-md-table-cell">Peso</th><th>PDF</th></tr></thead>
                <tbody id="pacotes-body"><tr><td colspan="5" class="text-center text-muted py-3"><i class="fas fa-spinner fa-spin me-1"></i></td></tr></tbody>
            </table></div></div></div>
    </div>
