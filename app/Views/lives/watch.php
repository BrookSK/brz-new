...
<style>
    /* Override para ficar dentro do layout do site (fundo branco) */
    .live-player-body { background: #fff; height: auto; overflow: visible; color: #000; }
    .live-container { height: 80vh; max-width: 430px; margin: 0 auto; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.15); }
    .video-wrapper video, .waiting-screen { border-radius: 0; }
    .waiting-screen { color: #fff; }
    @media (max-width: 576px) {
        .live-container { height: 85vh; max-width: 100%; border-radius: 0; box-shadow: none; margin: -1rem -12px; }
    }
</style>

<div class="container py-4">
    <div class="live-player-body">
