<?php
$pageTitle = 'Pedido Confirmado - Carnê Braziliana';
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-success">
                <div class="card-body text-center py-4">
                    ...
                    <p class="lead">Seu pedido #<?= $carne['pedido_id'] ?> foi registrado com pagamento via <strong>Carnê Braziliana</strong>.</p>
                </div>
            </div>
            ...
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><i class="fas fa-truck text-info"></i> O envio do pedido ocorrerá <strong>somente após a quitação total</strong> de todas as parcelas</li>
                        <li class="mb-2"><i class="fas fa-barcode text-primary"></i> O primeiro boleto já está disponível abaixo</li>
                        <li class="mb-2"><i class="fas fa-user text-secondary"></i> Acompanhe tudo em <a href="/meus-carnes"><strong>Minha Conta > Meus Carnês</strong></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card shadow-sm mt-4">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-barcode"></i> Primeira Parcela</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="border rounded p-3 text-center">
                                ...
                                <?php if (!empty($primeiraParcela['boleto_produtos_url'])): ?>
                                    <a href="<?= htmlspecialchars($primeiraParcela['boleto_produtos_url']) ?>" target="_blank" class="btn btn-primary">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="border rounded p-3 text-center">
                                ...
                                <?php if (!empty($primeiraParcela['boleto_taxas_url'])): ?>
                                    <a href="<?= htmlspecialchars($primeiraParcela['boleto_taxas_url']) ?>" target="_blank" class="btn btn-primary">
                                        <i class="fas fa-external-link-alt"></i> Abrir Boleto
                                    </a>
                                <?php else: ?>
                                    <span class="badge bg-info">Boleto será gerado em breve</span>
            ...
            <div class="text-center mt-4">
                <a href="/meus-carnes" class="btn btn-primary btn-lg">
                    <i class="fas fa-file-invoice-dollar"></i> Ver Meus Carnês
                </a>
